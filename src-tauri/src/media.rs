...
// makes Windows resolve the tile to YTMLite's own executable identity (name +
...
/// `org.mpris.MediaPlayer2.ytmlite`. Registration needs a session D-Bus,
