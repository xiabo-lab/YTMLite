        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {checking
              ...
              : signedOut
                ? "YTMLite plays music through your YouTube Music account. Sign in with an account that has an active Music Premium subscription."
          ...
          <>
            <div className="flex gap-3 rounded-lg border border-border/60 bg-surface p-3">
              ...
              <p className="text-xs leading-relaxed text-muted-foreground">
                ...
                Service require those ads to play, and YTMLite has no way to
                show them, so YouTube limits ad-free playback to Premium
                accounts.{" "}
                <span className="font-medium text-foreground">
                  YTMLite itself stays completely free and open source, and
                  always will be.
                </span>{" "}
