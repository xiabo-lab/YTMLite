  ...
  return (
    <Group>
      <SettingRow
        ...
        description="Start YTMLite automatically when you log in."
        control={
          <Switch
      ...
      <SettingRow
        ...
        description={
          caps.trayLeftClick
            ? "Hide YTMLite to the tray when you press ✕ instead of quitting."
            : // Linux tray icons go through AppIndicator, which delivers
              ...
              "Hide YTMLite to the tray when you press ✕ instead of quitting. Bring it back from the tray icon's menu."
        }
        control={
          <Switch
